  ...
  <div class="w3-bar w3-black w3-card">
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        ...
        <a href="${ctp}/study/mail/mailForm" class="w3-bar-item w3-button">메일전송연습</a>
...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  ...
  <a href="#contact" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">Pds</a>
	<hr />
	<a href="${ctp}/study/password/sha256" class="w3-bar-item w3-button">SHA256</a>
	<a href="${ctp}/study/password/aria" class="w3-bar-item w3-button">ARIA</a>
	<a href="${ctp}/study/password/bCryptPassword" class="w3-bar-item w3-button">Security</a>
</div>